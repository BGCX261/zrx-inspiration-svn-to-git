...
namespace Inspiration.DataAccess
{
    public class ManageContext : DbContext, IDbContext
    {

        public DbSet<Inspiration.Model.User> Users { get; set; }
        public DbSet<Inspiration.Model.Group> Groups { get; set; }
        public DbSet<Inspiration.Model.Person> Persons { get; set; }

        public ManageContext()
            : base("InspirationEntities")
        {
